...
import com.example.w3c_school.service.DataTypeService;
import com.example.w3c_school.service.DataTypeService.OnListener;
...
//	private String videoUrl = UtilsURL.ROOT_URL + "/video/20131207_204318.mp4";
	...
	public void getTip() {
		...
		if (!type.equals("w")) {
			...
			Toast.makeText(getApplicationContext(), "当前处于wifi网络", Toast.LENGTH_SHORT).show();
		}
